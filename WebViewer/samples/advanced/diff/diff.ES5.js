!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Lt = {
          ...
          filter: function(t) {
            return Tt(this, X(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        kt = function(t, n) {
          return Tt(this, pt.call(Pt(this), t, n));
        },
        Ct = function(t) {
          Pt(this);
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return St in r ? It(v, r) : Mt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      var m,
        ...
        A = P || x(d),
        T = d ? (_ ? x('entries') : A) : void 0,
        I = ('Array' == n && O.entries) || P;
      if (
        (I && (S = s(I.call(new t()))) !== Object.prototype && S.next && (f(S, w, !0), e || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? A : x('values'), keys: y ? A : x('keys'), entries: T }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function U(t, n, r, e, o, i) {
      ...
      for (var c = t[I]._b, a = u + t[M], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      M = !!(function() {
        try {
          ...
          return (T || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
      ...
      R = function(t) {
        g.call(a, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                T ? E.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = T || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
  ...
  function(t, n) {
    ...
    !(function(t) {
      ...
      var n,
        ...
        h = 'overlayPanel';
      function v(t) {
        return s[t].instance.Core.documentViewer.getDocument();
      }
      function d(t) {
        return s[t].instance.Core.documentViewer;
      }
      function y() {
        var n = 1,
          r = 1;
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), d(n).loadDocument(r);
                  case 2:
                  case 'end':
                    return t.stop();
                }
      ...
      function x(t, n, r, e, o, i) {
        v(p).updatePageWithAlignment(r, e, t, n, i, o);
      }
      function w(e) {
          ...
          WebViewer(
            {
              ...
              workerTransportPromise:
                ((c = e.pdf),
                (l = 'object' === o(c) ? c.name : c || ''),
                (p = l.endsWith('docx') || l.endsWith('pptx') || l.endsWith('xlsx')),
                p && i
                  ? i
                  : !p && r
                  ? r
                  : Core.getDefaultBackendType().then(function(t) {
                      return c && p ? (i = Core.initOfficeWorkerTransports(t, {}, void 0)) : (r = Core.initPDFWorkerTransports(t, {}, void 0));
                    })),
            ...
            i.addEventListener('documentLoaded', function() {
              o.setLayoutMode(l.Single), o.setFitMode(p.FitWidth);
            }),
              (y.onscroll = function() {
                var r, e;
                t.DiffAlignmentTool.isInAlignmentMode() ||
                  ...
                  f.forEach(function(t) {
                    var n = s[t.panel].documentContainer;
              ...
              i.addEventListener('pageNumberUpdated', function(n) {
                t.DiffAlignmentTool.isInAlignmentMode()
                  ? e.panel !== h &&
                    f.forEach(function(t) {
                      d(t.panel).getCurrentPage() !== n && t.panel !== h && d(t.panel).setCurrentPage(n);
                    })
                  : S(n);
              }),
              f.push(e),
              (s[e.panel] = { instance: r, documentContainer: y }),
              u();
          });
        });
      }
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), Promise.all([m(l, r), m(h, e)]);
                  case 2:
                    t.DiffAlignmentTool.initializeDiffAlignmentToolHandlers(
                      ...
                      function() {},
                      function() {
                        S(d(p).getCurrentPage());
                      }
                    ),
                      (o = s[l].instance.Core.documentViewer.getDocument()),
                      (i = s[h].instance.Core.documentViewer.getDocument()),
                      (u = [
                        { document: o, Core: s[l].instance.Core },
                        { document: i, Core: s[h].instance.Core },
                      ]),
                      t.CompareDocumentManager.initialize(s[p].instance.Core, u, {
      ...
      (u = [{ panel: l }, { panel: p }, { panel: h }]),
          ...
          regeneratorRuntime.mark(function n() {
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), _(''.concat(window.location.href, '../../../samples/files/test_doc_1.pdf'), ''.concat(window.location.href, '../../../samples/files/test_doc_2.pdf'));
                  case 2:
                    t.NudgeTool.initializeNudgeTool(function(t) {
                      g(t);
                    }),
                      (document.getElementById('enable-snap-mode').disabled = !s[l].instance.Core.isFullPDFEnabled() && !s[h].instance.Core.isFullPDFEnabled());
                  case 4:
                  case 'end':
                    return n.stop();
                }
        ...
        Promise.all(u.map(w)).then(function() {
          return s[p].instance.UI.disableElements(['leftPanelButton', 'searchButton', 'searchPanel', 'searchOverlay']), c();
        }),
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (t.next = 7),
                        _(window.location.href + e, window.location.href + i)
                      );
                    case 7:
                    case 'end':
                      return t.stop();
            ...
            regeneratorRuntime.mark(function t(n) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (r = document.getElementById('url').value), (e = document.getElementById('url2').value), (t.next = 5), _(r, e);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
            ...
            regeneratorRuntime.mark(function t(n) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (r = document.forms['file-picker-form'][0].files[0]), (e = document.forms['file-picker-form'][1].files[0]), (t.next = 5), _(r, e);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
        ...
        document.getElementById('enable-opacity-slider').addEventListener('change', function() {
          ...
          t.DiffOverlaySlider.setValue(+r / 100), y();
        }),
        document.getElementById('opacity-slider').addEventListener('change', function() {
          ...
          t.DiffOverlaySlider.setValue(+n / 100), y();
        });
    })(window);
  },
]);
